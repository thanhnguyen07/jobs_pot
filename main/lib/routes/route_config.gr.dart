...
abstract class $AppRouter extends _i20.RootStackRouter {
  ...
  final Map<String, _i20.PageFactory> pagesMap = {
    ...
    DuoCamRoute.name: (routeData) {
      return _i20.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i6.DuoCamScreen(),
      );
    },
    ...
    EmailVerificationRoute.name: (routeData) {
      return _i20.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.EmailVerificationScreen(),
      );
    },
    ...
    HomeStackRoute.name: (routeData) {
      return _i20.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i11.HomeStackScreen(),
      );
    },
...
/// generated route for
/// [_i6.DuoCamScreen]
class DuoCamRoute extends _i20.PageRouteInfo<void> {
  const DuoCamRoute({List<_i20.PageRouteInfo>? children})
      : super(
          DuoCamRoute.name,
          initialChildren: children,
        );

  static const String name = 'DuoCamRoute';
